...
export class BotClient extends Client {
  ...
  public atcClass: Map<string, Atc>;
  ...
  public getAtc = (guild: Guild): Atc => {
    if (!this.atcClass.has(guild.id)) this.atcClass.set(guild.id, new Atc(guild));
    return this.atcClass.get(guild.id)!;
  }
